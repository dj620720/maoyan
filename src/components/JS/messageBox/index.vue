<template>
     <div class="messageBox">
          ...
          <p>{{content}}</p>
          <div>
               <div @touchstart="handelCancel">{{cancel}}</div>
               <div @touchstart="handelOk">{{ok}}</div>
          </div>
     </div>
</template>
<script>
...
<style scoped>
     .messageBox{
     width:200px;height: 120px;border:1px solid #ccc;border-radius: 4px;box-shadow: 3px 3px 3px 3px #ccc;position: absolute;left:50%;top:50%;margin:-60px 0 0 -100px;background: #fff;
     }
